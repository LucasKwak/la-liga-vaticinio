...
var partidosRMA = ["GRA", "ALA", "VIL", "BET"];
var partidosGIR = ["ALA", "VIL", "VAL", "GRA"];
var partidosBAR = ["RSO", "ALM", "RAY", "SEV"]; 
var partidosATM = ["CEL", "GET", "OSA", "RSO"];
var partidosATH = ["OSA", "CEL", "SEV", "RAY"];
var partidosBET = ["ALM", "LPA", "RSO", "RMA"];
var partidosRSO = ["BAR", "VAL" ,"BET", "ATM"];
var partidosLPA = ["MLL", "BET", "CAD", "ALA"];
var partidosVAL = ["RAY", "RSO", "GIR", "CEL"];
var partidosGET = ["CAD", "ATM", "ALA", "MLL"];
var partidosOSA = ["ATH", "MLL", "ATM", "VIL"];
var partidosALA = ["GIR", "RMA", "GET", "LPA"];
var partidosVIL = ["SEV", "GIR", "RMA" ,"OSA"];
var partidosRAY = ["VAL", "GRA", "BAR", "ATH"];
var partidosSEV = ["VIL", "CAD", "ATH", "BAR"];
var partidosCEL = ["ATM", "ATH", "GRA", "VAL"];
var partidosMLL = ["LPA", "OSA", "ALM", "GET"];
var partidosCAD = ["GET", "SEV", "LPA", "ALM"];
var partidosGRA = ["RMA", "RAY", "CEL", "GIR"];
var partidosALM = ["BET", "BAR", "MLL", "CAD"];
...
var realMadrid = new Equipo("RMA", 87, 34, 27, 6, 1, 74, 22, 1);
var girona = new Equipo("GIR", 74, 34, 23, 5, 6, 73, 42, 2);
var barcelona = new Equipo("BAR", 73, 34, 22, 7, 5, 70, 43, 3);
var atleticoMadrid = new Equipo("ATM", 67, 34, 21, 4, 9, 63, 39, 4);
var athleticBilbao = new Equipo("ATH", 61, 34, 17, 10, 7, 55, 33, 5);
var realSociedad = new Equipo("RSO", 54, 34, 14, 12, 8, 48, 35, 6);
var betis = new Equipo("BET", 52, 34, 13, 13, 8, 43, 39, 7);
var valencia = new Equipo("VAL", 47, 34, 13, 8, 13, 37, 39, 8);
var villareal = new Equipo("VIL", 45, 34, 12, 9, 13, 56, 58, 9);
var getafe = new Equipo("GET", 43, 34, 10, 13, 11, 41, 47, 10);
var alaves = new Equipo("ALA", 41, 34, 11, 8, 15, 32, 38, 11);
var sevilla = new Equipo("SEV", 41, 34, 10, 11, 13, 45, 46, 12);
var osasuna = new Equipo("OSA", 39, 34, 11, 6, 17, 37, 51, 13);
var lasPalmas = new Equipo("LPA", 37, 34, 10, 7, 17, 30, 43, 14);
var celta = new Equipo("CEL", 34, 34, 8, 10, 16, 40, 52, 15);
var rayoVallecano = new Equipo("RAY", 34, 34, 7, 13, 14, 27, 43, 16);
var mallorca = new Equipo("MLL", 32, 34, 6, 14, 14, 27, 40, 17);
var cadiz = new Equipo("CAD", 26, 34, 4, 14, 16, 23, 49, 18);
var granada = new Equipo("GRA", 21, 34, 4, 9, 21, 36, 64, 19);
var almeria = new Equipo("ALM", 17, 34, 2, 11, 21, 33, 67, 20);
...
var equipos = [realMadrid, girona, barcelona, atleticoMadrid, athleticBilbao, betis, realSociedad, lasPalmas, valencia, osasuna, getafe, villareal, alaves, sevilla, mallorca, rayoVallecano, celta, cadiz, granada, almeria];
...
function crearElementoTablaClasificacion(posicion, nomEquipo, puntos, partidosJugados, partidosPerdidos, partidosEmpatados, partidosGanados, golesFavor, golesContra, diferenciaGoles) {
    ...
    if(posicion <= 4){
        puesto.classList.add("champions");
    }else{
        if(posicion == 5){
            puesto.classList.add("europa-league");
        }else{
            if(posicion == 6){
                puesto.classList.add("conference");
            }else{
                if(posicion >= 18){
    ...
    imgEscudo.src = "images/laligaea/" + nomEquipo + ".png";
...
function actualizarTabla() {
    ...
    equipos.forEach(function(equipo) {
      var fila = crearElementoTR(equipo.posicion, "images/laligaea/" + equipo.nombre + ".png", equipo.nombre, equipo.puntos, equipo.partidosJugados, equipo.numVictorias, equipo.numEmpates, equipo.numDerrotas, equipo.golesFavor, equipo.golesContra, equipo.diferenciaGoles);
...
botonPronostico.addEventListener("click", function(){
    ...
    switch (equipos[indiceEquipo].nombre) {
        case 'RMA':
            partidosEquipo = partidosRMA;
            break;
        case 'BAR':
            partidosEquipo = partidosBAR;
            break;
        case 'GIR':
            partidosEquipo = partidosGIR;
            break;
        case 'ATM':
            partidosEquipo = partidosATM;
            break;
        case 'ALM':
            partidosEquipo = partidosALM;
            break;
        case 'GRA':
            partidosEquipo = partidosGRA;
            break;
        case 'CAD':
            partidosEquipo = partidosCAD;
            break;
        case 'SEV':
            partidosEquipo = partidosSEV;
            break;
        case 'RAY':
            partidosEquipo = partidosRAY;
            break;
        case 'VIL':
            partidosEquipo = partidosVIL;
            break;
        case 'ALA':
            partidosEquipo = partidosALA;
            break;
        case 'OSA':
            partidosEquipo = partidosOSA;
            break;
        case 'GET':
            partidosEquipo = partidosGET;
            break;
        case 'VAL':
            partidosEquipo = partidosVAL
            break;
        case 'LPA':
            partidosEquipo = partidosLPA;
            break;
        case 'RSO':
            partidosEquipo = partidosRSO;
            break;
        case 'BET':
            partidosEquipo = partidosBET;
            break;
        case 'ATH':
            partidosEquipo = partidosATH;
            break;
        case 'CEL':
            partidosEquipo = partidosCEL;
            break;
        case 'MLL':
            partidosEquipo = partidosMLL;
            break;
        default:
...
function crearPronostico(equipo1, equipo2, equipo3, equipo4, equipo5, equipo6, equipo7, equipo8, equipo9, equipo10, equipo11, equipo12, puntos, resultados, indiceEnPosiblesEquipos) {
    ...
    var imgEscudo = document.createElement("img");
    imgEscudo.src = "images/laligaea/" + equipo1 + ".png";
